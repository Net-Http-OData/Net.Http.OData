...
namespace Net.Http.OData.Query
{
    ...
    public enum AllowedFunctions
    {
        ...
        /// <summary>
        /// Specifies that the 'totaloffsetminutes' function is allowed in the $filter query option.
        /// </summary>
        TotalOffsetMinutes = 1048576,
        ...
        /// <summary>
        /// Specifies that the 'totalseconds' function is allowed in the $filter query option.
        /// </summary>
        TotalSeconds = 268435456,
        ...
        /// </summary>
        AllDateTimeFunctions = Date | Day | FractionalSeconds | Hour | MaxDateTime | MinDateTime | Minute | Month | Now | Second | Time | TotalSeconds | TotalOffsetMinutes | Year,
